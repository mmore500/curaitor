...
class TestPDFTextMining(unittest.TestCase):
    ...
    @patch('script.textMining.StringIO', create=True, return_value=StringIO("Extracted text"))
    @patch('script.textMining.PDFResourceManager')
    @patch('script.textMining.TextConverter', return_value=MagicMock(auto_spec=True))
    @patch('script.textMining.PDFPageInterpreter')
    @patch('script.textMining.PDFDocument', return_value=MagicMock(auto_spec=True))
    @patch('script.textMining.PDFParser', return_value=MagicMock(auto_spec=True))
